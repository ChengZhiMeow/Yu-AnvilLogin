package cn.chengzhiya.yuanvillogin.builder;
...
public final class ItemStackBuilder {
    ...
    public ItemStackBuilder name(String name) {
        ...
        TextComponent text = ColorUtil.color(Main.instance.getPluginHookManager().getPlaceholderAPIHook().placeholder(getPlayer(), name));
    ...
    public ItemStackBuilder lore(List<String> lore) {
        ...
        List<TextComponent> textList = lore.stream()
        ...
        if (PluginUtil.isNativeSupportAdventureApi()) {
            ...
            meta.setLore(textList.stream()
                    .map(TextComponent::toLegacyString)
                    .toList()
            );
        }
        this.item.setItemMeta(meta);
